  ...
  return (
    <div className="">
      <div className="my-80 flex flex-col justify-center">
         <Image src="/Logonew.svg" width={1800} height={0} alt="Food House Logo"/>
         <h2 className="ml-3 sm:ml-8 lg:ml-8 xl:ml-11 2xl:ml-14 text-fcolor">Serves a bite of authenticity.</h2>
      </div>
      <div className="my-10 md:my-32"><h1 className="text-center text-fcolor">Why Us?</h1>
        <div className="p-10 flex flex-col gap-10 lg:flex-row justify-around">
          <div className="bg-fcolor/90 text-white lg:w-[30%] justify-items-center p-10 rounded-3xl">
