...
export default function MCard(fc: {
  ...
  return (
    <div className="p-3 rounded-xlp shadow-lg border border-black/20 shadow-black/50 sm:w-[42%] md:w-[40%] lg:w-[40%] xl:w-[90%]">
        <div className="flex">
                <Image className="rounded-tl-xl w-[40%]" src={`/${fc.img}`}  width={500} height={0} alt={fc.name}/>
            <div className="pl-2">
                <h3 className="h-22 sm:h-32 md:h-28 lg:h-20 xl:h-18">{fc.name}</h3>
                <p className="h-22 sm:h-32 md:h-28 lg:h-20 xl:h-28">{fc.detail}</p>
            </div>
        </div>
