...
export default function Review() {
  ...
  return (
    <div className="my-28 justify-items-center">
      ...
      <div className="m-10 p-10 md:p-5 lg:p-10 rounded-3xl border border-black/20 shadow-black/50 shadow-xl md:w-[40%]">
        ...
        <p className="content-center text-xl h-36 lg:h-24">{currentReview.review}</p>
        <h3 className="text-right">{currentReview.name}</h3>
        <div className="mt-5 justify-self-end">
          <button
            className="mx-2 p-2 px-8 rounded-xl bg-black text-white text-xl font-inter font-semibold"
